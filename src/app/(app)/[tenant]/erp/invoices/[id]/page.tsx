...
import { Calendar, Clock, Warehouse, User as UserIcon } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="no-print">
        <ErpPageHeader
          title={invoice.invoiceNumber || `Factura #${invoice.id}`}
          breadcrumbHref={`/${tenantSlug}/erp/invoices`}
          breadcrumbLabel="Facturación & Ventas"
          actions={
            <>
      ...
      <div className="print-area space-y-6">
        ...
        <div className="rounded-xl border border-border bg-card overflow-hidden">
          <h2 className="text-sm font-semibold text-foreground p-4 border-b border-border">
            Líneas de Detalle
          </h2>
        ...
        <div className="rounded-xl border border-border bg-card overflow-hidden">
          ...
          {payments.length === 0 ? (
            <p className="text-xs text-muted-foreground p-4">Sin cobros registrados.</p>
          ) : (
            <div className="overflow-x-auto">
              <Table>
                <TableHeader>
                ...
                return (
                  <li key={String(entry.id)} className="p-3 flex items-center justify-between gap-3">
                    <span className="text-muted-foreground">
                      <span className="font-semibold text-foreground">{String(entry.operation)}</span>
                      {diffKeys && <span className="text-muted-foreground/70"> ({diffKeys})</span>}
                      <span> por </span>
