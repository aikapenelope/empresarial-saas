...
export function ConvertQuoteModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res.success) {
      ...
      setError(res.error || 'Error al convertir la cotización');
    }
  };
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={`Convertir ${quote.quoteNumber} a Factura`}
      description="Genera la factura heredando las líneas cotizadas. Contado captura el recibo automáticamente; crédito valida el límite del cliente."
      maxWidth="lg"
    >
