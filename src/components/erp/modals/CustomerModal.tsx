    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4 text-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block font-semibold text-foreground mb-1">Razón Social / Nombre *</label>
            <input
              type="text"
              required
              value={name}
          ...
          <div>
            <label className="block font-semibold text-foreground mb-1">RIF / Cédula / Tax ID *</label>
            <input
              type="text"
              required
              value={taxId}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block font-semibold text-foreground mb-1">WhatsApp / Teléfono *</label>
            <input
              type="tel"
              required
              value={phone}
        ...
        <div>
          <label className="block font-semibold text-foreground mb-1">Dirección Fiscal / Despacho</label>
          <input
            type="text"
            value={address}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block font-semibold text-foreground mb-1">Segmentación CRM</label>
            <select
              value={status}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label className="block font-semibold text-foreground mb-1">Tier de Precio</label>
            <select
              value={priceTier}
        ...
        {creditAllowed && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-3 rounded-xl border border-border bg-muted/50 animate-in fade-in">
            <div>
            ...
            <div>
              <label className="block font-semibold text-foreground mb-1">Días de Crédito (Gracia)</label>
              <input
                type="number"
                min="1"
                value={creditDays}
