...
// + IGTF informativo en cobros. Idempotente.
//
// NOTA (Devin #60): NO se retro-alimenta el IVA de facturas históricas.
// El taxRate ACTUAL del catálogo no representa la clasificación al momento
// de emisión (cambia por decreto; productos pueden estar eliminados) y un
// INNER JOIN perdería líneas con producto removido: fabricar el snapshot
// inventaría datos. Las facturas previas al Sprint 42 quedan con 0/0 =
// "desglose no disponible" para el contador.
